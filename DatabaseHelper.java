...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    @Override public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (id TEXT PRIMARY KEY,nama_pelanggan TEXT,jns_paket TEXT,jns_layanan TEXT,jumlah INTEGER,tgl_selesai TEXT,harga INTEGER)");
    }
